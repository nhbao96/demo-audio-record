...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/amplify_auth_cognito_ios/amplify_auth_cognito_ios.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/amplify_core/amplify_core.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/amplify_flutter_ios/amplify_flutter_ios.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/amplify_storage_s3_ios/amplify_storage_s3_ios.framework"
