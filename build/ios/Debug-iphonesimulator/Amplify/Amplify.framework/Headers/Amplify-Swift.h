...
#ifndef AMPLIFY_SWIFT_H
#define AMPLIFY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Amplify",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7Amplify21AsynchronousOperation")
@interface AsynchronousOperation : NSOperation
/// <code>true</code> if the operation is ready to be executed
@property (nonatomic, readonly, getter=isReady) BOOL ready;
/// <code>true</code> if the operation is currently executing
@property (nonatomic, readonly, getter=isExecuting) BOOL executing;
/// <code>true</code> if the operation has completed executing, either successfully or with an error
...
- (void)start;
/// Subclasses must implement this to perform their work and they must not call <code>super</code>.
